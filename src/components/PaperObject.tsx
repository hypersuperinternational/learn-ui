...
const PaperObject: React.FC<PaperObjectProps> = ({data, onImageClick}) => {
    ...
    return (
        <div className="paper-object-container">
            ...
            <div 
                className={`paper-object-detail-overlay fixed pb-4 overflow-y-auto overscroll-contain touch-none w-screen max-h-screen flex flex-col gap-4 left-0 z-20 ease-out-learn transition-all
                    ${!overlayTop && 'hidden'}
